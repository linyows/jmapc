...
// paramSet collects the parameters a request leaves open, in the order they first
...
// by, making them unique within the request. They are given here in the shape Go
...
func assignFieldNames(q *Request) {
...
// request gave it, which is unique within a request by definition and stays put
