...
// RequestCheck holds a request to the same standard a request file is held to,
// as its calls arrive.
//
// A request file is checked before anything is sent. A request that arrives at a
...
// held to the calls before it, exactly as one in a request file is.
