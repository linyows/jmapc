...
// file as generated for the tools that read one, and it is how jmapc tells its
// own output apart from a file put in the same directory by hand.
const GeneratedBanner = "// Code generated by jmapc. DO NOT EDIT."
