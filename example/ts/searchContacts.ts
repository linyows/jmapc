...
export async function searchContacts(client: Client, p: SearchContactsParams): Promise<SearchContactsResult> {
  ...
  return {
    addressBookGet: decode<SearchContactsAddressBookGetResponse>(req, res, "books"),
    contactCardQuery: decode<ContactCardQueryResponse>(req, res, "search"),
    contactCardGet: decode<SearchContactsContactCardGetResponse>(req, res, "fetch"),
  }
}
